...
export default function AdminProducts() {
  ...
  if (loading) return <p className="text-stone-400 text-sm">Loading products…</p>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 flex items-center gap-2">
                ...
                <label htmlFor="offer" className="text-sm text-meat-accent font-medium">Special Offer</label>
              </div>
            </div>
              ...
              {products.map((p) => (
                <tr key={p.id} className="border-b border-stone-100">
                  ...
                  <td className="py-3 pr-4">
                    ...
                    >
                      {p.is_special_offer ? 'On Offer' : 'Normal'}
                    </button>
                  </td>
